    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('og_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='camomilla_page_related', to='camomilla.Media')),
            ],
            options={
                'verbose_name': 'Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contents', to='camomilla.Page')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(max_length=200, unique=True)),
                ('status', models.CharField(choices=[('PUB', 'Published'), ('DRF', 'Draft'), ('TRS', 'Trash'), ('PLA', 'Planned')], default='DRF', max_length=3)),
                ('date', models.DateTimeField(auto_now=True)),
                ('pubblication_date', models.DateTimeField(blank=True, null=True)),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('categories', models.ManyToManyField(blank=True, to='camomilla.Category')),
                ('highlight_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='camomilla.Media')),
                ('og_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='camomilla_article_related', to='camomilla.Media')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master'), ('title', 'language_code')},
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(db_index=True, max_length=15)),
                ('master', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='camomilla.Page')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'managed': True,
                'default_permissions': (),
                'unique_together': {('permalink', 'language_code'), ('language_code', 'master')},
            },
        ),
    ]
