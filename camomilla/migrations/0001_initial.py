    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='camomilla.Page')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'managed': True,
                'default_permissions': (),
                'unique_together': {('title', 'language_code'), ('language_code', 'master')},
            },
        ),
        migrations.CreateModel(
